class TrieNode():
    def __init__(self, trie_network=None, feature_value=None):
        ...
        self.trie_network = trie_network  # Assign the neural network passed to the node. This attribute stores the neural network associated with this node.
